...
public class EditObjectDefinitionMVCActionCommand extends BaseMVCActionCommand {
	...
	protected void doProcessAction(
		...
		boolean categorization = ParamUtil.getBoolean(
			actionRequest, "categorization");
		boolean comments = ParamUtil.getBoolean(actionRequest, "comments");
		...
		try {
			...
			_objectDefinitionService.updateCustomObjectDefinition(
				...
				accountEntryRestricted, active, categorization, comments,
