...
public class ObjectDefinitionLocalServiceTest {
	...
	private void _testObjectDefinitionSystemFields(
		...
		objectFieldBuilder = objectFieldBuilder.dbTableName(
			dbTableName
		).defaultValue(
			StringPool.BLANK
		);
		...
		for (ObjectField objectField : objectFields) {
			if (StringUtil.equals(objectField.getName(), "createDate")) {
				_testObjectDefinitionSystemFields(
					objectFieldBuilder.businessType(
						...
						LocalizedMapUtil.getLocalizedMap(
							LanguageUtil.get(
								LocaleUtil.getDefault(), "create-date"))
					).name(
						"createDate"
					).build(),
					objectField);
			}
			else if (StringUtil.equals(objectField.getName(), "creator")) {
				_testObjectDefinitionSystemFields(
					objectFieldBuilder.businessType(
				...
				Assert.assertFalse(
					"External Reference Code field must not be created in a " +
			...
			else if (StringUtil.equals(objectField.getName(), "modifiedDate")) {
				_testObjectDefinitionSystemFields(
					objectFieldBuilder.businessType(
						ObjectFieldConstants.BUSINESS_TYPE_DATE
					).dbColumnName(
						...
						LocalizedMapUtil.getLocalizedMap(
							LanguageUtil.get(
								LocaleUtil.getDefault(), "modified-date"))
					).name(
						"modifiedDate"
					).build(),
					objectField);
			}
			else if (StringUtil.equals(objectField.getName(), "status")) {
				_testObjectDefinitionSystemFields(
					objectFieldBuilder.businessType(
						ObjectFieldConstants.BUSINESS_TYPE_TEXT
					).dbColumnName(
