...
public class ObjectDefinitionLocalServiceTest {
	...
	public void testAddSystemObjectDefinition() throws Exception {
		...
		// Modifiable system object

		objectDefinition =  _testPublishSystemObjectDefinition();

		Assert.assertTrue(objectDefinition.getEnableCategorization());
		Assert.assertFalse(objectDefinition.getEnableComments());
		Assert.assertTrue(objectDefinition.isModifiable());
		Assert.assertTrue(objectDefinition.isSystem());
		Assert.assertTrue(_hasTable(objectDefinition.getDBTableName()));
		Assert.assertTrue(
	...
	private ObjectDefinition _testPublishSystemObjectDefinition() throws PortalException {
		ObjectDefinition objectDefinition =
