...
public abstract class BaseObjectDefinitionResourceImpl
	...
	public ObjectDefinition patchObjectDefinition(
		...
		if (objectDefinition.getAccountEntryRestrictedObjectFieldId() != null) {
			existingObjectDefinition.setAccountEntryRestrictedObjectFieldId(
		...
		if (objectDefinition.getCategorization() != null) {
			existingObjectDefinition.setCategorization(
				objectDefinition.getCategorization());
		}

		if (objectDefinition.getComments() != null) {
			existingObjectDefinition.setComments(
				objectDefinition.getComments());
		}
