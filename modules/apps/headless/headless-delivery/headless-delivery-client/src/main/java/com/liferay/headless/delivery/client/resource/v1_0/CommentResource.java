...
public interface CommentResource {
	...
	public HttpInvoker.HttpResponse getSiteObjectEntryCommentsPageHttpResponse(
			Long siteId, Long objectEntryId, String search,
			List<String> aggregations, String filterString,
			Pagination pagination, String sortString)
		throws Exception;
	...
	public static class CommentResourceImpl implements CommentResource {
		...
		public Page<Comment> getSiteObjectEntryCommentsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getSiteObjectEntryCommentsPageHttpResponse(
					siteId, objectEntryId, search, aggregations, filterString,
					pagination, sortString);
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-delivery/v1.0/sites/{siteId}/object-entry/{objectEntryId}/comments");

			httpInvoker.path("siteId", siteId);
			httpInvoker.path("objectEntryId", objectEntryId);
