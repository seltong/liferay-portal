...
public class InstanceResourceImpl extends BaseInstanceResourceImpl {
	...
	public Instance getProcessInstance(Long processId, Long instanceId)
		...
		BooleanQuery booleanQuery = _createInstancesBooleanQuery(
			new Long[0], new Long[0], null, null, null, null, processId,
	...
	public Page<Instance> getProcessInstancesPage(
			...
			Boolean completed, Boolean pending, Date dateEnd, Date dateStart,
			String[] slaStatuses, String[] taskNames, Pagination pagination)
		throws Exception {

		long instanceCount = _getInstanceCount(
			assigneeIds, classPKs, completed, pending, dateEnd, dateStart,
			processId, slaStatuses, taskNames);
		...
		if (instanceCount > 0) {
			...
			if (pagination.getEndPosition() > 10000) {
				...
				while (endPosition > 10000) {
					startInstanceId = _getInstanceId(
						assigneeIds, classPKs, completed, pending, dateEnd,
						dateStart, processId, slaStatuses, startInstanceId,
						taskNames);
			...
			return Page.of(
				_getInstances(
					assigneeIds, classPKs, completed, pending, dateEnd,
					dateStart, pagination, processId, slaStatuses,
	...
	private BooleanQuery _createInstancesBooleanQuery(
		Long[] assigneeIds, Long[] classPKs, Boolean completed, Boolean pending,
		...
		countSearchRequest.setQuery(
			booleanQuery.addFilterQueryClauses(
				_createInstancesBooleanQuery(
					assigneeIds, classPKs, completed, pending, dateEnd,
					dateStart, processId, slaStatuses, null, taskNames)));
	...
	private Collection<Instance> _getInstances(
		Long[] assigneeIds, Long[] classPKs, Boolean completed, Boolean pending,
		Date dateEnd, Date dateStart, Pagination pagination, long processId,
